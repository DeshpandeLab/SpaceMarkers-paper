...
expression_matrix <- ReadMtx(
  mtx = "VisiumData/HCC/single_cell_data/hcc13/matrix.mtx",
  features = "VisiumData/HCC/single_cell_data/hcc13/genes.tsv",
  cells = "VisiumData/HCC/single_cell_data/hcc13/barcodes.tsv"
)
...
scale_cogap <- read.csv(file = "VisiumData/HCC/single_cell_data/cogap_hcc13/projection_15_128.csv", row.names = 1)
...
######################### Atul spaceMarker #########################
p1p8 <- read.table(file='VisiumData/CoGAPS/1541/SpaceMarkers_15_residual_Pattern_1_x_Pattern_8.txt')
p2p8 <- read.table(file='VisiumData/CoGAPS/1541/SpaceMarkers_15_residual_Pattern_2_x_Pattern_8.txt')
